...
public class Account {
  ...
  protected static final int NUMBER_OF_TOKEN_LIMIT = 10;
  protected static final int TOKEN_EXP_BUFFER_SECONDS = 1; // 종종 하나의 토큰으로 여러개의 요청이 올 수 있다. 바로 삭제하지 않고 버퍼를 둔다.
